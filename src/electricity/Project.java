...
public class Project extends JFrame implements ActionListener {
   String meter;
    Project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon/Light-bulb_1.jpg"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon/calculate bill.png"));
        ...
        info1.setBackground(Color.PINK);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{Runtime.getRuntime().exec("C:\\Program Files\\Mozilla Firefox\\firefox.exe");
            }catch(Exception e){ }
